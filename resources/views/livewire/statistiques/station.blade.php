<div>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <select id="inputState" wire:model.live="station" class="form-select">
                <option value=""></option>
        ...
        <div class="col-md-6">
            ...
            <select id="inputState" wire:model.live="nature" class="form-select">
                <option value=""></option>
    ...
    <div class="row">
        <div class="col-4">
            <div class="card text-center">
                ...
                @else
                    <h2 class="card-title">consomation :
                        {{ $bons->unique('numero_bon')->sum('prix') }}</h2>
                @endif
            </div>
        </div>
    </div>
